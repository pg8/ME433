...
int8_t message[256] __attribute__((coherent, aligned(4)));

int8_t message2[256] __attribute__((coherent, aligned(4)));
...
//            }
            if(appData.isReadComplete == true)
            {
                ...
                DRV_USART_Write(appData.usartHandle, appData.readBuffer, appData.readLength);
                           ...
                           unsigned int leftAmount = 19000*COMpos +2500;
                           unsigned int rightAmount = 4864000-leftAmount;



                          //OC2RS = leftAmount/256;
                          //OC1RS = rightAmount/256;
...
//
            if(COMpos<=128){
                centerDist = (128-COMpos)*(128-COMpos);
                OC1RS=20000;
                OC2RS=20000-(centerDist);
                //OC1RS=19000;
                //OC2RS=19000;
                //LATBbits.LATB7=0;
                //LATBbits.LATB13=1;
            }
//                            else if(message2[0]=='s'){
//                OC1RS=19000;
//                OC2RS=19000;
//                LATBbits.LATB7=0;
//                LATBbits.LATB13=0;
...
//            }
                                ...
                                centerDist = ((COMpos-128)*(COMpos-128));
                                OC2RS=20000;
                                OC1RS = 20000-(centerDist);
...
//                            }
        ...
        case APP_STATE_CHECK_UART_RECEIVE:
            ...
            sprintf(message,"%d \n\r",count);
            writeRequestResult = USB_DEVICE_CDC_Write(0, &appData.writeTransferHandle, message, 20, USB_DEVICE_CDC_TRANSFER_FLAGS_DATA_COMPLETE);
            _CP0_SET_COUNT(0);}
