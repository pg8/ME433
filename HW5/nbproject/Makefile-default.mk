...
SOURCEFILES_QUOTED_IF_SPACED=spi_accel.c pic_code.c ../I2C/i2c_display.c ../I2C/i2c_master_int.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/spi_accel.o ${OBJECTDIR}/pic_code.o ${OBJECTDIR}/_ext/1360894859/i2c_display.o ${OBJECTDIR}/_ext/1360894859/i2c_master_int.o
POSSIBLE_DEPFILES=${OBJECTDIR}/spi_accel.o.d ${OBJECTDIR}/pic_code.o.d ${OBJECTDIR}/_ext/1360894859/i2c_display.o.d ${OBJECTDIR}/_ext/1360894859/i2c_master_int.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/spi_accel.o ${OBJECTDIR}/pic_code.o ${OBJECTDIR}/_ext/1360894859/i2c_display.o ${OBJECTDIR}/_ext/1360894859/i2c_master_int.o

# Source Files
SOURCEFILES=spi_accel.c pic_code.c ../I2C/i2c_display.c ../I2C/i2c_master_int.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/HW5.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/HW5.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}           -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC00490:0x1FC00BEF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/HW5.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/HW5.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
