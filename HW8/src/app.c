            ...
            else if( appData.hidDataReceived )
            {
                ...
                switch(appData.receiveDataBuffer[0])
                {
                    case 0x80:
                        ...
                        char row = appData.receiveDataBuffer[1];
                        int xIndex = 2;
                        int yIndex = (row*9)-6;
                        //int yIndex = ((appData.receiveDataBuffer[1])*9)-8;
                        unsigned char message[50]="                              ";
                        int iii;
                        for(iii=2;iii<=26;iii++){
                            message[iii-2]=appData.receiveDataBuffer[iii];

                                drawChar(message[iii-2]-0x20,xIndex, yIndex);
                                xIndex+=6;
                    ...
                    case 0x81:
                        ...
                        if(appData.hidDataTransmitted)
                        {
                            ...
                            unsigned char sendAccel1;

                            unsigned char sendAccel2;
                            ...
                            /*sendAccel1 = (unsigned char)(accels[1]>>8);
                            sendAccel2 = (unsigned char)(accels[1]&0b0000000011111111);;*/
                            if(_CP0_GET_COUNT()>=200000){
                            sprintf(appData.transmitDataBuffer,"%d %d %d",accels[0],accels[1],accels[2]);
